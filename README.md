# MeshStampPress
3D printing files for a stamp press design, to be used in the process of making holey mesh supports for TEM grids

Parts were optimized for printing with PETG, specifically Elegoo Rapid PETG. PLA should also work fine, though I have not done much testing.

The All_Parts_3_Plates.3mf file contains all the parts laid out with slicer settings.
